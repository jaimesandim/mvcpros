...
@Controller
@RequestMapping("/prosettings")

public class ProSettingsController {
    private static final List<ProSettings> ProConfigs = new ArrayList<ProSettings>();

    public ProSettingsController() {
    ...
    @GetMapping
    public String getProConfigs(Model model){
        model.addAttribute("ProConfigs", ProConfigs);
        return "ProConfigs";
    }
}
